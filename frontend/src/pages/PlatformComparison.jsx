  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        subtitle="YouTube and Instagram use real data (synced or realistic sample data). TikTok is simulated until a data source is connected."
      />

      {error && <ErrorState message={error} />}
      {loading && <LoadingState label="Loading platform comparison..." />}
