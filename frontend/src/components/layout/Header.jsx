  ...
  return (
    <header className="flex min-h-20 items-center justify-between border-b border-white/10 bg-gradient-to-r from-slate-950 via-indigo-950 to-slate-900 px-4 shadow-[0_14px_34px_rgba(15,23,42,0.18)] backdrop-blur-md sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="hidden rounded-2xl border border-white/10 bg-white/10 px-3.5 py-1.5 text-right shadow-inner shadow-white/5 sm:block">
        ...
        <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 text-base font-extrabold text-white shadow-md shadow-indigo-500/20 ring-4 ring-indigo-500/20">
          {initial}
        </div>
        ...
        <button
          type="button"
          onClick={logout}
          className="ml-1 rounded-xl border border-white/15 bg-white/10 px-3.5 py-2 text-sm font-semibold text-slate-100 shadow-sm transition hover:border-red-300/40 hover:bg-red-500/15 hover:text-red-200 focus:outline-none focus:ring-2 focus:ring-sky-300/50"
        >
