...
export default function PlatformComparison() {
  ...
  return (
    <div className="space-y-4">
      ...
      {rows.length === 0 && !error && (
        <div className="bg-white border border-slate-200 rounded-xl p-8 text-center text-slate-500 text-sm dark:bg-slate-900 dark:border-slate-800 dark:text-slate-400">
        ...
        <>
          ...
          <div className="bg-white border border-slate-200 rounded-xl overflow-x-auto dark:bg-slate-900 dark:border-slate-800">
            <table className="w-full text-sm">
              ...
              <tbody>
                {rows.map((r) => (
                  <tr key={r.platform} className="border-b border-slate-200/50 dark:border-slate-800/50">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            <a href="/growth" className="text-sky-600 hover:underline dark:text-sky-400">Growth &amp; Trends</a> page
