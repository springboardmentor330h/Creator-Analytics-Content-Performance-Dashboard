...
function MetricCard({
  ...
  return (
    <SpotlightCard className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
      <div className="relative z-10 flex items-start justify-between">
        ...
        <div className={`rounded-xl p-2.5 transition-transform duration-200 group-hover:scale-110 group-hover:-rotate-6 ${iconBg}`}>
          <Icon className={`h-5 w-5 ${iconColor}`} />
        </div>
      </div>

      <div className="pointer-events-none absolute -bottom-8 -right-8 h-20 w-20 rounded-full bg-slate-50 transition-transform duration-300 group-hover:scale-150" />
    </SpotlightCard>
  );
}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <div className="relative z-10 flex items-start justify-between">
            ...
            <div className="rounded-xl bg-amber-50 p-2.5 transition-transform duration-200 group-hover:scale-110 group-hover:rotate-6">
              <Award className="h-5 w-5 text-amber-500" />
            </div>

          </div>

          <div className="pointer-events-none absolute -bottom-8 -right-8 h-20 w-20 rounded-full bg-amber-50/50 transition-transform duration-300 group-hover:scale-150" />
